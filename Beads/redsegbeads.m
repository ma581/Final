...
% Modified version of REDSEG to segment and keep suitable beads which can be used to produce a heatmap 
% Outputs 'Sbeads_001-1.mat' which stores the results of segmentation. 
...
% The function PROGTHRESHFLOUR carries out the bead segmentation
