...
numWells = 3; %input('Enter number of wells visited: ');
numSubwells = 45; %input('Enter number of snapshots within each well: ');
outputFile =  'JLB50_NaCl_Triton'; %input('Enter new file name, surrounded by single quotes: ');
...
for i = 1 : numWells,
    for j = 1 : numSubwells,
        ...
        im = imread([inputFile num2str(str3((i-1)*numSubwells + (j+2))) '.tif']);
