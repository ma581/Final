numWells = 6; %input('Enter number of wells visited: ');
numSubwells = 25; %input('Enter number of snapshots within each well:TOTAL, that is, nr of positions multiplied by 5 ');
inputFile = 'awell-y-'; %input('Enter original file header, surrounded by single quotes: ');
outputFile = 'Pasteur'; %input('Enter new file name, surrounded by single quotes: ');
