...
function [mystats,Lq,Lo] = collectstats(fimgs,L,qualfunc); %fimgs: flat colored images normally (rfp and yfp)
...
if n>0,
    ...
    qualifies = feval(ourqualfunc,stats); %creats vector of the soze of the number cells in the image with 1s.
