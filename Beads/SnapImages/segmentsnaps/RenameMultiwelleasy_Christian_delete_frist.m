...
outputFile =  'JLB54_sigM_NaCl'; %input('Enter new file name, surrounded by single quotes: ');
...
for i = 1 : numWells,
    for j = 1 : numSubwells,
        disp(['Reading input file = ' inputFile num2str(str3((i-1)*numSubwells + (j+3))) '.tif'])
        im = imread([inputFile num2str(str3((i-1)*numSubwells + (j+3))) '.tif']);
