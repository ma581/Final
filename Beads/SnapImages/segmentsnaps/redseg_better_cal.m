...
%Find and kill small cells
r = regionprops(L2,'Area');
flittle2 = find([r.Area]>100);
disp(['Removing big (crud) cells(', num2str(length(flittle2)),').']);
goodones = setdiff(1:max(max(L2)), flittle2);
bw3 = ismember(L2, goodones);
L3 = bwlabel(bw3);
