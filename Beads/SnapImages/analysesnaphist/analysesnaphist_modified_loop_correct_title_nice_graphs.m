function analysesnaphist_modified_loop(varargin)
global savedata;
...
for i=1:length(prefixes)
    ...
    subplot_tight(3,3,j);
    if exist([prefixes{i},'.jpg'])~=0
        image(imread([prefixes{i},'.jpg']));
        axis off;
        j=j+1;
    end
end
...
plot(x,histarea*y,'r','LineWidth',3)
%End Gammafit Code
end
...
if i==1
title(input,'Fontsize',20, 'fontweight', 'bold')
end
