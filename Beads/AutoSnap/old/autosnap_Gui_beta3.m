...
if handles.pads==0
    ...
    autosnap_beta_error_send(handles.pads,handles.number_of_pos, handles.posname, handles.cstring, get(handles.output_folder, 'String'), handels.posname_title, get(handles.auto_print,'Value'))
end
...
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
cd([get(handles.path,'String'),get(handles.output_folder)]);
h=hgload('output.fig');
