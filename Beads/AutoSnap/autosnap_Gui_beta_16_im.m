function varargout = autosnap_Gui_beta_16_im(varargin)
% AUTOSNAP_GUI_BETA_16_IM MATLAB code for autosnap_Gui_beta_16_im.fig
%      AUTOSNAP_GUI_BETA_16_IM, by itself, creates a new AUTOSNAP_GUI_BETA_16_IM or raises the existing
%      singleton*.
%
%      H = AUTOSNAP_GUI_BETA_16_IM returns the handle to a new AUTOSNAP_GUI_BETA_16_IM or the handle to
%      the existing singleton*.
%
%      AUTOSNAP_GUI_BETA_16_IM('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in AUTOSNAP_GUI_BETA_16_IM.M with the given input arguments.
%
%      AUTOSNAP_GUI_BETA_16_IM('Property','Value',...) creates a new AUTOSNAP_GUI_BETA_16_IM or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before autosnap_Gui_beta_16_im_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to autosnap_Gui_beta_16_im_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help autosnap_Gui_beta_16_im

% Last Modified by GUIDE v2.5 06-Nov-2014 09:03:23

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @autosnap_Gui_beta_16_im_OpeningFcn, ...
                   'gui_OutputFcn',  @autosnap_Gui_beta_16_im_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before autosnap_Gui_beta_16_im is made visible.
function autosnap_Gui_beta_16_im_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to autosnap_Gui_beta_16_im (see VARARGIN)

% Choose default command line output for autosnap_Gui_beta_16_im
handles.output = hObject;

% Update handles structure
guidata(hObject, handles);

% UIWAIT makes autosnap_Gui_beta_16_im wait for user response (see UIRESUME)
% uiwait(handles.figure1);


% --- Outputs from this function are returned to the command line.
function varargout = autosnap_Gui_beta_16_im_OutputFcn(hObject, eventdata, handles) 
