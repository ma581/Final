function varargout = autosnap_Gui_Douglas(varargin)
% AUTOSNAP_GUI_DOUGLAS MATLAB code for autosnap_Gui_Douglas.fig
%      AUTOSNAP_GUI_DOUGLAS, by itself, creates a new AUTOSNAP_GUI_DOUGLAS or raises the existing
%      singleton*.
%
%      H = AUTOSNAP_GUI_DOUGLAS returns the handle to a new AUTOSNAP_GUI_DOUGLAS or the handle to
%      the existing singleton*.
%
%      AUTOSNAP_GUI_DOUGLAS('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in AUTOSNAP_GUI_DOUGLAS.M with the given input arguments.
%
%      AUTOSNAP_GUI_DOUGLAS('Property','Value',...) creates a new AUTOSNAP_GUI_DOUGLAS or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before autosnap_Gui_Douglas_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to autosnap_Gui_Douglas_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help autosnap_Gui_Douglas

% Last Modified by GUIDE v2.5 06-Sep-2014 10:15:52

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @autosnap_Gui_Douglas_OpeningFcn, ...
                   'gui_OutputFcn',  @autosnap_Gui_Douglas_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before autosnap_Gui_Douglas is made visible.
function autosnap_Gui_Douglas_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to autosnap_Gui_Douglas (see VARARGIN)

% Choose default command line output for autosnap_Gui_Douglas
handles.output = hObject;

% Update handles structure
guidata(hObject, handles);

% UIWAIT makes autosnap_Gui_Douglas wait for user response (see UIRESUME)
% uiwait(handles.figure1);


% --- Outputs from this function are returned to the command line.
function varargout = autosnap_Gui_Douglas_OutputFcn(hObject, eventdata, handles) 
...
if handles.pads==0
    ...
    autosnap_beta_error_send_3(handles.pads,handles.number_of_pos, handles.posname, handles.cstring, get(handles.output_folder, 'String'), handels.posname_title, get(handles.auto_print,'Value'))
end
